...
def generate_launch_description():
    ...
    is_edge = LaunchConfiguration('is_edge')
    ...
    declare_is_edge_cmd = DeclareLaunchArgument(
        name='is_edge',
        default_value='True',
        description='Whether this launch file is run on the edge or at home (as ui mainly)')
    ...
    start_robot_state_publisher_cmd = Node(
        condition=IfCondition(PythonExpression(
            [use_robot_state_pub, ' and ', is_edge])),
    ...
    ld.add_action(declare_is_edge_cmd)
